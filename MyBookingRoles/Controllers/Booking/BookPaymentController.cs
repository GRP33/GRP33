...
namespace MyBookingRoles.Controllers.Booking
{
    public class BookPaymentController : Controller
    {
        ...
        {
            var model = (Models.Booking.Bookings)Session["book"];
           ...
           // var order = new BookPayment();
            ...
            itemList.items.Add(new Item()
            {
                ...
                currency = "ZAR",
                price = model.TotalDue.ToString(),
                description= "Booking for " + book.Artist.ArtistName +  " on " + book.Date,
                sku = model.UserID.ToString(),
            ...
            var details = new Details()
            {
                ...
                shipping = book.Location,
                subtotal = book.Discount.ToString(),
            ...
            {
                currency = "ZAR",
                total = model.TotalDue.ToString(), // Total must be equal to sum of tax, shipping and subtotal.
            ...
            transactionList.Add(new Transaction()
            {
                ...
                invoice_number = "gd-bvots-BookNo" + model.BookingID.ToString(), //Generate an Invoice No
                amount = amount,
                item_list = itemList
        ...
        public ActionResult PaymentWithCard()
        {
            ...
            var model = new Models.Booking.Bookings();
            var itemList = new ItemList() { items = new List<Item>() };
...

            {
                currency = "ZAR",
                price = model.TotalDue.ToString(),
                description = "Booking for " + model.Artist.ArtistName + " on " + model.Date,
                sku = model.UserID.ToString(),
            ...
            //bill.first_name = order.FirstName;
           ...
           // var oe = new OrderDetails();
            ...
            details.shipping = model.Location;
            details.subtotal = model.PackageCost + model.Service.ServicePrice + model.ArtistRateFee + model.BookingFee + model.EventFee.ToString();
                
           // details.tax = oe.Quantity.ToString();
            // oder Details
            Amount amount = new Amount();
            amount.total = model.TotalDue.ToString();
            amount.details = details;

            //transaction Object
            Transaction trans = new Transaction();
            trans.amount = amount;
            trans.description = "Event booking";
            trans.item_list = itemList;
            trans.invoice_number = "gd-bvots-BookNo" + model.BookingID.ToString();//Generate an Invoice No
